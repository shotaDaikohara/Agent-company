...
実装（Phase 1〜2）が本書の目標設計に対してどこまで到達しているか、実際のコンポーネントがどう連携して動くかは
[system-mechanics.md](system-mechanics.md) を参照。両者が食い違う場合は、動いているコードを記述した
system-mechanics.md を優先する。
